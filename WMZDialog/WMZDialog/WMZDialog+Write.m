...
- (UIView*)writeAction{
    ...
    [self reSetMainViewFrame:CGRectMake(0, 0, self.wWidth, CGRectGetMaxY(view.frame)+self.wMainOffsetY)];
...
- (BOOL)textView:(UITextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        rect.size.height = CGRectGetMaxY(view.frame)+self.wMainOffsetY;
